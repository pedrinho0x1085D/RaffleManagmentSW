...
public class BuyTicketGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Registar Rifa");
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("/UI/plus.png")).getImage());
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuyTicketGUI(new MainScreenGUI()).setVisible(true);
            }
        });
    }
