...
public class FullSorteioGUI extends javax.swing.JFrame {
    ...
    public FullSorteioGUI(int prize,SorteioGUI map) {
        try{
            BufferedImage myImage = ImageIO.read(getClass().getResource("/UI/backgroundsortsfull.jpg"));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, -1, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/ball.png"))); // NOI18N
