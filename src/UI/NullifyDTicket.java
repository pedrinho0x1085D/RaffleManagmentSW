 ...
 * @author PedroJosé
 */
public class NullifyDTicket extends javax.swing.JFrame {

    private CountDownGUI gui;
    private static int howmany = 1;

    /**
     * Creates new form NullifyDTicket
     */
    public NullifyDTicket(CountDownGUI cdgui) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NullifyDTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
